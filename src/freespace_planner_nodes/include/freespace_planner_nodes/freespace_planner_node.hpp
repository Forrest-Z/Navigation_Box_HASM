...
#include <aiim_autoware_msgs/action/planner_costmap.hpp>
...
private:
  ...
  using PlannerCostmapAction = aiim_autoware_msgs::action::PlannerCostmap;
  ...
  rclcpp::Publisher<aiim_autoware_msgs::msg::TrajectoryAutoware>::SharedPtr trajectory_debug_pub_;
  ...
  aiim_autoware_msgs::msg::TrajectoryAutoware trajectory_;
