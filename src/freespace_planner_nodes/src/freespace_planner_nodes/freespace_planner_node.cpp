...
using aiim_autoware_msgs::action::PlannerCostmap;
...
aiim_autoware_msgs::msg::TrajectoryAutoware createTrajectory(
  ...
  const float & velocity)
{
  ...
  for (const auto & awp : planner_waypoints.waypoints) {
    ...
    aiim_autoware_msgs::msg::TrajectoryPointAutoware point;
...
: Node("freespace_planner", node_options)
{
  ...
  // Publisher
  {
    ...
    trajectory_debug_pub_ =
      ...
      create_publisher<aiim_autoware_msgs::msg::TrajectoryAutoware>("~/debug/trajectory", qos);
...
void FreespacePlannerNode::reset()
{
  ...
  trajectory_ = aiim_autoware_msgs::msg::TrajectoryAutoware();
}
