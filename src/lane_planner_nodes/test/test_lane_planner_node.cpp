...
using aiim_autoware_msgs::srv::HADMapService;
using PlanTrajectory = aiim_autoware_msgs::action::PlanTrajectoryAutoware;
using aiim_autoware_msgs::msg::HADMapRoute;
using aiim_autoware_msgs::msg::HADMapSegment;
using aiim_autoware_msgs::msg::MapPrimitive;
...
public:
    ...
    const std::shared_ptr<HADMapService::Response> response)
  {
    ...
    aiim_autoware_msgs::msg::HADMapBin map_msg;
