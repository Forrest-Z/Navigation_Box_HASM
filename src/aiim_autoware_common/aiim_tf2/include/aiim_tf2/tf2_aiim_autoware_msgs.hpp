...
/// \file
/// \brief This file includes common transform functionality for aiim_autoware_msgs

#ifndef AIIM_AUTOWARE_TF2__TF2_AIIM_AUTOWARE_MSGS_HPP_
#define AIIM_AUTOWARE_TF2__TF2_AIIM_AUTOWARE_MSGS_HPP_
...
#include <aiim_autoware_msgs/msg/quaternion32.hpp>
...
/** \brief Apply a geometry_msgs TransformStamped to an aiim_autoware_msgs Quaternion32 type.
 * This function is a specialization of the doTransform template defined in tf2/convert.h.
...
template <>
inline void doTransform(
        const aiim_autoware_msgs::msg::Quaternion32& t_in,
        aiim_autoware_msgs::msg::Quaternion32& t_out,
        const geometry_msgs::msg::TransformStamped& transform) {
...
/** \brief Apply a geometry_msgs TransformStamped to an aiim_autoware_msgs BoundingBox type.
 * This function is a specialization of the doTransform template defined in tf2/convert.h.
...
template <>
inline void doTransform(
        const BoundingBox& t_in, BoundingBox& t_out, const geometry_msgs::msg::TransformStamped& transform) {
    t_out = t_in;
...
/** \brief Apply a geometry_msgs TransformStamped to an aiim_autoware_msgs BoundingBoxArray type.
 * This function is a specialization of the doTransform template defined in tf2/convert.h.
...
template <>
inline void doTransform(
        const BoundingBoxArray& t_in, BoundingBoxArray& t_out, const geometry_msgs::msg::TransformStamped& transform) {
    t_out = t_in;
...
#endif  // AIIM_AUTOWARE_TF2__TF2_AIIM_AUTOWARE_MSGS_HPP_
