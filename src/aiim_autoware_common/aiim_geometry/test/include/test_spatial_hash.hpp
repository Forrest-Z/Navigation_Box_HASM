...
#include <limits>
#include <vector>
#include "aiim_geometry/spatial_hash.hpp"

using aiim::common::geometry::spatial_hash::Config2d;
using aiim::common::geometry::spatial_hash::Config3d;
using aiim::common::geometry::spatial_hash::SpatialHash;
using aiim::common::geometry::spatial_hash::SpatialHash2d;
using aiim::common::geometry::spatial_hash::SpatialHash3d;
