...
#include <aiim_helper_functions/angle_utils.hpp>
...
///
template <typename ScalarT, typename... VariableTs>
struct STATE_VECTOR_PUBLIC is_state<GenericState<ScalarT, VariableTs...>> : public std::true_type {};
