...
struct COMMON_PUBLIC index<HeadT, std::tuple<HeadT, Tail...>> : std::integral_constant<std::int32_t, 0> {};
...
COMMON_PUBLIC inline typename std::enable_if_t<I == sizeof...(TypesT)> visit(std::tuple<TypesT...>&, Callable) {}
/// @brief      Same as the previous specialization but for const tuple.
template <std::size_t I = 0UL, typename Callable, typename... TypesT>
COMMON_PUBLIC inline typename std::enable_if_t<I == sizeof...(TypesT)> visit(const std::tuple<TypesT...>&, Callable) {}
...
///
template <std::size_t I = 0UL, typename Callable, typename... TypesT>
COMMON_PUBLIC inline typename std::enable_if_t<I != sizeof...(TypesT)> visit(
        std::tuple<TypesT...>& tuple, Callable callable) {
