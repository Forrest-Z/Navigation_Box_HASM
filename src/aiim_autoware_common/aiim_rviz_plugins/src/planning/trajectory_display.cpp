...
TrajectoryDisplay::TrajectoryDisplay()
    : rviz_common::RosTopicDisplay<aiim_autoware_msgs::msg::Trajectory>(),
...
void TrajectoryDisplay::update(float32_t wall_dt, float32_t ros_dt) { m_marker_common->update(wall_dt, ros_dt); }
...
visualization_msgs::msg::Marker::SharedPtr TrajectoryDisplay::create_pose_marker(const TrajectoryPoint& point) const {
...
PLUGINLIB_EXPORT_CLASS(aiim::rviz_plugins::TrajectoryDisplay, rviz_common::Display)
