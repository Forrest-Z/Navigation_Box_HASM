...
#include <aiim_autoware_msgs/msg/point_clusters.hpp>
...
TEST(ordered_check, basic) {
  ...
  std::vector<aiim_autoware_msgs::msg::PointXYZIF> points_list = {
    ...
    make_points<aiim_autoware_msgs::msg::PointXYZIF>(8.0, 4.0),
    make_points<aiim_autoware_msgs::msg::PointXYZIF>(9.0, 1.0),
    make_points<aiim_autoware_msgs::msg::PointXYZIF>(3.0, 2.0),
    make_points<aiim_autoware_msgs::msg::PointXYZIF>(2.0, 5.0)
  };
  ...
  points_list = {
    ...
    make_points<aiim_autoware_msgs::msg::PointXYZIF>(0.0, 0.0),
    make_points<aiim_autoware_msgs::msg::PointXYZIF>(1.0, 1.0),
    make_points<aiim_autoware_msgs::msg::PointXYZIF>(1.0, 0.0),
    make_points<aiim_autoware_msgs::msg::PointXYZIF>(2.0, 1.0)
  };
  EXPECT_FALSE(autoware::common::geometry::all_ordered(points_list.begin(), points_list.end()));
  ...
  points_list = {
    ...
    make_points<aiim_autoware_msgs::msg::PointXYZIF>(2.0, 2.0),
    make_points<aiim_autoware_msgs::msg::PointXYZIF>(4.0, 4.0),
    make_points<aiim_autoware_msgs::msg::PointXYZIF>(6.0, 6.0)
  };
  EXPECT_TRUE(autoware::common::geometry::all_ordered(points_list.begin(), points_list.end()));
  ...
  points_list = {
    ...
    make_points<aiim_autoware_msgs::msg::PointXYZIF>(-39.1, -83.3),
    make_points<aiim_autoware_msgs::msg::PointXYZIF>(-38.7, -83.7),
    make_points<aiim_autoware_msgs::msg::PointXYZIF>(-36.5, -85.3),
    make_points<aiim_autoware_msgs::msg::PointXYZIF>(-34.7, -86.5),
    make_points<aiim_autoware_msgs::msg::PointXYZIF>(-35.1, -86.1),
    make_points<aiim_autoware_msgs::msg::PointXYZIF>(-35.9, -85.5),
    make_points<aiim_autoware_msgs::msg::PointXYZIF>(-37.3, -84.5),
    make_points<aiim_autoware_msgs::msg::PointXYZIF>(-38.7, -83.5),
  };
  EXPECT_TRUE(autoware::common::geometry::all_ordered(points_list.begin(), points_list.end()));
}
