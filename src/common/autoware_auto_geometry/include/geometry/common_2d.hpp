...
/// \return The x value of the point
/// \param[in] pt The point
inline auto x_(const aiim_autoware_msgs::msg::TrajectoryPointAutoware & pt)
{
...
/// \return The y value of the point
/// \param[in] pt The point
inline auto y_(const aiim_autoware_msgs::msg::TrajectoryPointAutoware & pt)
{
...
/// \return The z value of the point
/// \param[in] pt The point
inline auto z_(const aiim_autoware_msgs::msg::TrajectoryPointAutoware & pt)
{
...
inline auto & xr_(aiim_autoware_msgs::msg::TrajectoryPointAutoware & pt)
{
  return pt.pose.position.x;
}
...
/// \param[in] pt The TrajectoryPoint
inline auto & yr_(aiim_autoware_msgs::msg::TrajectoryPointAutoware & pt)
{
  return pt.pose.position.y;
}
...
/// \param[in] pt The TrajectoryPoint
inline auto & zr_(aiim_autoware_msgs::msg::TrajectoryPointAutoware & pt)
{
  return pt.pose.position.z;
}
}  // namespace point_adapter
