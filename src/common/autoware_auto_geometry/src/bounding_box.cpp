...
aiim_autoware_msgs::msg::Shape make_shape(const BoundingBox & box)
{
  // autoware_auto_perception_msgs::msg::Shape retval;
  aiim_autoware_msgs::msg::Shape retval;
...
aiim_autoware_msgs::msg::DetectedObject make_detected_object(const BoundingBox & box)
{
  // autoware_auto_perception_msgs::msg::DetectedObject ret;
  aiim_autoware_msgs::msg::DetectedObject ret;
  ...
  ret.kinematics.orientation_availability =
    ...
    aiim_autoware_msgs::msg::DetectedObjectKinematics::SIGN_UNKNOWN;
  ...
  aiim_autoware_msgs::msg::ObjectClassification label;
  // label.classification = autoware_auto_perception_msgs::msg::ObjectClassification::UNKNOWN;
  label.classification =  aiim_autoware_msgs::msg::ObjectClassification::UNKNOWN;
...
std::vector<geometry_msgs::msg::Point32> GEOMETRY_PUBLIC get_transformed_corners(
  ...
  const aiim_autoware_msgs::msg::Shape & shape_msg,
