...
bool8_t Lanelet2GlobalPlanner::plan_route(
  TrajectoryPointAutoware & start_point,
  TrajectoryPointAutoware & end_point, std::vector<lanelet::Id> & route) const
{
...
TrajectoryPointAutoware Lanelet2GlobalPlanner::refine_pose_by_parking_spot(
  const lanelet::Id & parking_id,
  const TrajectoryPointAutoware & input_point)
const
{
  ...
  TrajectoryPointAutoware center_p1, center_p2;
  ...
  TrajectoryPointAutoware refined_point;
