...
void SymmetricEigensolver3x3::computeEigenvector0(
        double a00, double a01, double a02, double a11, double a12, double a22, int i0) {
...
void SymmetricEigensolver3x3::computeEigenvector1(
        double a00, double a01, double a02, double a11, double a12, double a22, int i0, int i1) {
    Eigen::Vector3d u, v;
