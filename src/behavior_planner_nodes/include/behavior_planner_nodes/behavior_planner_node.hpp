...
#include <aiim_autoware_msgs/action/plan_trajectory_autoware.hpp>
#include <aiim_autoware_msgs/msg/trajectory_autoware.hpp>
#include <aiim_autoware_msgs/msg/trajectory_point_autoware.hpp>
#include <aiim_autoware_msgs/msg/vehicle_kinematic_state_autoware.hpp>
// #include <autoware_auto_vehicle_msgs/msg/gear_report.hpp>
// #include <autoware_auto_vehicle_msgs/msg/gear_command.hpp>
#include <aiim_autoware_msgs/msg/gear_report.hpp>
#include <aiim_autoware_msgs/msg/gear_command.hpp>
...
#include <aiim_autoware_msgs/msg/vehicle_state_report.hpp> //There is a difference between aiim and autoware on wiperclean msg
#include <aiim_autoware_msgs/srv/had_map_service.hpp>
#include <aiim_autoware_msgs/srv/modify_trajectory_autoware.hpp>
...
using PlanTrajectoryAction = aiim_autoware_msgs::action::PlanTrajectoryAutoware;
...
using HADMapService = aiim_autoware_msgs::srv::HADMapService;
// using autoware_auto_planning_msgs::srv::ModifyTrajectory;
using ModifyTrajectory = aiim_autoware_msgs::srv::ModifyTrajectoryAutoware;
using geometry_msgs::msg::Pose;
// using autoware_auto_planning_msgs::msg::Trajectory;
// using autoware_auto_planning_msgs::msg::TrajectoryPoint;
// using autoware_auto_planning_msgs::msg::HADMapRoute;
// using autoware_auto_vehicle_msgs::msg::VehicleStateReport;
using Trajectory = aiim_autoware_msgs::msg::TrajectoryAutoware;
using TrajectoryPoint = aiim_autoware_msgs::msg::TrajectoryPointAutoware;
using aiim_autoware_msgs::msg::HADMapRoute;
using aiim_autoware_msgs::msg::VehicleStateReport;

// using autoware_auto_vehicle_msgs::msg::GearReport;
// using autoware_auto_vehicle_msgs::msg::GearCommand;
using aiim_autoware_msgs::msg::GearReport;
using aiim_autoware_msgs::msg::GearCommand;

using GEAR_TYPE =
  std::remove_const<decltype(aiim_autoware_msgs::msg::GearReport::DRIVE_1)>::type;
// using State = autoware_auto_vehicle_msgs::msg::VehicleKinematicState;
using State = aiim_autoware_msgs::msg::VehicleKinematicStateAutoware;
...
private:
  ...
  rclcpp::Client<aiim_autoware_msgs::srv::ModifyTrajectory>::SharedPtr m_modify_trajectory_aiim_client;
  ...
  rclcpp::Publisher<aiim_autoware_msgs::msg::Trajectory>::SharedPtr m_trajectory_aiim_pub{};
  ...
  void modify_trajectory_response(rclcpp::Client<aiim_autoware_msgs::srv::ModifyTrajectory>::SharedFuture future);
  ...
  aiim_autoware_msgs::msg::Trajectory getTrajectory(const Trajectory &trajectory) const;
