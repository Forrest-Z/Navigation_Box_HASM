...
TEST(object_collision_estimator, sanity) { object_collision_estimator_test(100, 40); }
...
TEST(object_collision_estimator, no_obstacle) { object_collision_estimator_test(100, 101); }
