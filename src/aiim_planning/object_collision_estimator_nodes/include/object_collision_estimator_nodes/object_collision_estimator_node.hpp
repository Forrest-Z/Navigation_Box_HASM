...
private:
    ...
    rclcpp::Service<aiim_autoware_msgs::srv::ModifyTrajectory>::SharedPtr m_service_interface{nullptr};
    ...
    static constexpr const char* OBJECT_COLLISION_ESTIMATOR_NODE_NAME = "object_collision_estimator_node";
};
