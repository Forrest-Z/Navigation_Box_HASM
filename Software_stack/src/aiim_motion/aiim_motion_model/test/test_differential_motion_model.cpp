...
// * Adding aiim prefix
#include <aiim_motion_model/differential_drive_motion_model.hpp>
...
using aiim::motion::motion_model::CatrMotionModel;
using aiim::motion::motion_model::CvtrMotionModel;
...
TEST(CvtrMotionModelTest, TestJacobianNonZeroTurnRate) {
  ...
  // Computed with SymPy.
  CvtrMotionModel::State::Matrix expected_jacobian{
      (CvtrMotionModel::State::Matrix{} << 1.0F, 0.0F, -0.112740374605884F,
...
TEST(CatrMotionModelTest, TestJacobianNonZeroTurnRate) {
  ...
  // Computed with SymPy.
  CatrMotionModel::State::Matrix expected_jacobian{
      (CatrMotionModel::State::Matrix{} << 1.0F, 0.0F, -0.1186522F, 0.0823960F,
       -0.0063150F, 0.0040257F, 0.0F, 1.0F, 0.1728437F, 0.0563701F, 0.0085819F,
       0.0029559277F, 0.0F, 0.0F, 1.0F, 0.0F, 0.1F, 0.0F, 0.0F, 0.0F, 0.0F,
       1.0F, 0.0F, 0.1F, 0.0F, 0.0F, 0.0F, 0.0F, 1.0F, 0.0F, 0.0F, 0.0F, 0.0F,
       0.0F, 0.0F, 1.0F)
          .finished()};
...
TEST(CvtrMotionModelTest, TestJacobianZeroTurnRate) {
  ...
  // Computed with SymPy.
  CvtrMotionModel::State::Matrix expected_jacobian{
      (CvtrMotionModel::State::Matrix{} << 1.0F, 0.0F, -0.0958851077208406F,
       0.0877582561890373F, -0.00958851077208406F, 0.0F, 1.0F,
       0.175516512378075F, 0.0479425538604203F, 0.0175516512378075F, 0.0F, 0.0F,
...
TEST(CatrMotionModelTest, TestJacobianZeroTurnRate) {
  ...
  // Computed with SymPy.
  CatrMotionModel::State::Matrix expected_jacobian{
      (CatrMotionModel::State::Matrix{} << 1.0F, 0.0F, -0.1006793F, 0.0877582F,
       -0.0100679F, 0.0043879F, 0.0F, 1.0F, 0.1842923F, 0.0479425F, 0.0184292F,
       0.0023971F, 0.0F, 0.0F, 1.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 1.0F,
       0.0F, 0.1F, 0.0F, 0.0F, 0.0F, 0.0F, 1.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F,
       0.0F, 1.0F)
          .finished()};
