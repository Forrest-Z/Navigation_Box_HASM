...
#include <aiim_motion_testing_nodes/periodic_publisher.hpp>
...
using aiim::motion::motion_testing_nodes::PeriodCountTopic;
using aiim::motion::motion_testing_nodes::PeriodicPublisher;

// Ugly global to persist some data across test cases
static int32_t count{0};

template <typename T> class PeriodicPublisherTest : public ::testing::Test {
protected:
  void SetUp() {
