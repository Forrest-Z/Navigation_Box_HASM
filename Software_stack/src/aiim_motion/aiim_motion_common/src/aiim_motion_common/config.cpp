...
////////////////////////////////////////////////////////////////////////////////
LimitsConfig::LimitsConfig(Extremum longitudinal_velocity_mps,
                           Extremum lateral_velocity_mps,
                           Extremum acceleration_mps2, Extremum yaw_rate_rps,
                           Extremum jerk_mps3, Extremum steer_angle_rad,
    ...
    : m_longitudinal_velocity_limits_mps{longitudinal_velocity_mps},
      ...
      m_yaw_rate_limits_rps{yaw_rate_rps}, m_jerk_limits_mps3{jerk_mps3},
      m_steer_angle_limits_rad{steer_angle_rad}, m_steer_angle_rate_limits_rps{
                                                     steer_angle_rate_rps} {}
...
////////////////////////////////////////////////////////////////////////////////
VehicleConfig::VehicleConfig(Real length_cg_front_axel_m,
                             Real length_cg_rear_axel_m,
                             Real front_cornering_stiffness_N,
                             Real rear_cornering_stiffness_N, Real mass_kg,
                             Real inertia_kgm2, Real width_m,
    ...
    : m_length_cg_to_front_axel_m{length_cg_front_axel_m},
      ...
      m_mass_kg{mass_kg}, m_inertia_kgm2{inertia_kgm2}, m_width_m{width_m},
      m_front_overhang_m{front_overhang_m}, m_rear_overhang_m{rear_overhang_m} {
}
...
////////////////////////////////////////////////////////////////////////////////
StateWeight::StateWeight(Real pose, Real heading, Real longitudinal_velocity,
                         Real lateral_velocity, Real yaw_rate,
                         Real acceleration, Real jerk, Real steer_angle,
                         Real steer_angle_rate)
    : m_pose_weight{pose}, m_heading_weight{heading},
      m_longitudinal_velocity_weight{longitudinal_velocity},
      m_lateral_velocity_weight{lateral_velocity}, m_yaw_rate_weight{yaw_rate},
      m_acceleration_weight{acceleration}, m_jerk_weight{jerk},
      m_steer_angle_weight{steer_angle}, m_steer_angle_rate_weight{
                                             steer_angle_rate} {
...
////////////////////////////////////////////////////////////////////////////////
OptimizationConfig::OptimizationConfig(StateWeight nominal_weights,
