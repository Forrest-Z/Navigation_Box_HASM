...
aiim_autoware_msgs::msg::TrajectoryPointAutoware convertToTrajectoryPoint(
  const geometry_msgs::msg::Pose & pose)
{
  aiim_autoware_msgs::msg::TrajectoryPointAutoware pt;
  pt.pose = pose;
  return pt;
}
  ...
  tf_listener(tf_buffer, std::shared_ptr<rclcpp::Node>(this, [](auto) {}), false)
{
  ...
  current_pose_sub_ptr =
    ...
    this->create_subscription<aiim_autoware_msgs::msg::VehicleKinematicStateAutoware>(
    "vehicle_kinematic_state", rclcpp::QoS(10),
    std::bind(&Lanelet2GlobalPlannerNode::current_pose_cb, this, _1));

  // Global path publisher
  global_path_pub_ptr =
    this->create_publisher<aiim_autoware_msgs::msg::HADMapRoute>(
    "global_path", rclcpp::QoS(10));

  // Create map client
  map_client =
    this->create_client<aiim_autoware_msgs::srv::HADMapService>("HAD_Map_Client");
...
void Lanelet2GlobalPlannerNode::request_osm_binary_map()
{
  ...
  auto request = std::make_shared<aiim_autoware_msgs::srv::HADMapService_Request>();
  request->requested_primitives.push_back(
    aiim_autoware_msgs::srv::HADMapService_Request::FULL_MAP);
  ...
  // copy message to map
  aiim_autoware_msgs::msg::HADMapBin msg = result.get()->map;
...
void Lanelet2GlobalPlannerNode::current_pose_cb(
  ...
  const aiim_autoware_msgs::msg::VehicleKinematicStateAutoware::SharedPtr msg)
  ...
  const std_msgs::msg::Header & header)
{
  ...
  // main route = other
  aiim_autoware_msgs::msg::HADMapRoute global_route;
