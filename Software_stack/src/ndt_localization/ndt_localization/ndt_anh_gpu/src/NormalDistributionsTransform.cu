...
void GNormalDistributionsTransform::setStepSize(double step_size) { step_size_ = step_size; }

void GNormalDistributionsTransform::setResolution(float resolution) { resolution_ = resolution; }

void GNormalDistributionsTransform::setOutlierRatio(double olr) { outlier_ratio_ = olr; }

double GNormalDistributionsTransform::getStepSize() const { return step_size_; }

float GNormalDistributionsTransform::getResolution() const { return resolution_; }

double GNormalDistributionsTransform::getOutlierRatio() const { return outlier_ratio_; }

double GNormalDistributionsTransform::getTransformationProbability() const { return trans_probability_; }
