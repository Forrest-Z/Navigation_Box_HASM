...
using aiim::state_vector::AngleVariable;
using aiim::state_vector::FloatState;
using aiim::state_vector::GenericState;
using aiim::state_vector::is_state;
...
TEST(KalmanFilterGenericStateTest, Print) {
    ...
    EXPECT_EQ(
            str_stream.str(),
            "State:\n  aiim::state_vector::variable::X: 42\n"
            "  aiim::state_vector::variable::Y: 23\n");
}
