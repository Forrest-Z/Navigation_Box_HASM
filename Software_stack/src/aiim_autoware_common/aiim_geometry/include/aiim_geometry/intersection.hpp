...
// * Removing dependency to motion_common
...
using aiim::common::geometry::convex_hull;
using aiim::common::geometry::dot_2d;
using aiim::common::geometry::get_normal;
using aiim::common::geometry::minus_2d;
using aiim::common::geometry::norm_2d;
using aiim::common::geometry::times_2d;
...
bool intersect(const Iter begin1, const Iter end1, const Iter begin2, const Iter end2) {
    ...
    for (const auto& face : faces) {
        ...
        auto get_position_along_line = [&normal](auto point) { return dot_2d(normal, minus_2d(point, Point{})); };
