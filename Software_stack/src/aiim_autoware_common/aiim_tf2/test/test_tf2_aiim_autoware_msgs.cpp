...
/// \file
/// \brief This file includes common transform functionaly for aiim_autoware_msgs
...
TEST(Tf2AiimAutoware, DoTransformPoint32) {
...
TEST(Tf2AiimAutoware, DoTransformQuaternion32) {
    const auto trans = filled_transfom();
    aiim_autoware_msgs::msg::Quaternion32 q1;
    q1.w = 0;
    q1.x = 0;
    q1.y = 0;
    q1.z = 1;
    ...
    // doTransform
    aiim_autoware_msgs::msg::Quaternion32 q_out;
...
TEST(Tf2AiimAutoware, DoTransformBoundingBox) {
    const auto trans = filled_transfom();
    BoundingBox bb1;
    bb1.orientation.w = 0;
    bb1.orientation.x = 0;
...
TEST(Tf2AiimAutoware, TransformBoundingBoxArray) {
    BoundingBox bb1;
    bb1.orientation.w = 0;
    bb1.orientation.x = 0;
    bb1.orientation.y = 0;
    ...
    // advanced api
    const auto bba_advanced = tf_buffer->transform(bba1, "B", tf2::timeFromSec(2.0), "A", tf2::durationFromSec(3.0));
