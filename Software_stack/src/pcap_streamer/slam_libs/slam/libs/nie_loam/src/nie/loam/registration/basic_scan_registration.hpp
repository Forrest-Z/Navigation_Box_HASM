...
#include "nie/loam/ros_interop/angle.hpp"
#include "nie/loam/ros_interop/vector3.hpp"
#include "nie/loam/utils/circular_buffer.hpp"
...
private:
     ...
     */
    void reset(const nie::Timestamp_ns& scanTime);
...
private:
    ...
    std::vector<IndexRange> _scanIndices;         ///< start and end indices of the individual scans withing
    ...
    nie::Timestamp_ns _sweepStart;         ///< time stamp of beginning of current sweep
    nie::Timestamp_ns _scanTime;           ///< time stamp of most recent scan
    ...
    pcl::PointCloud<pcl::PointXYZI> _imuTrans = {4, 1};  ///< IMU transformation information
