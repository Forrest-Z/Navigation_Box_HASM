...
#ifndef KITTI_BENCHMARKER_MATRIX_HPP
#define KITTI_BENCHMARKER_MATRIX_HPP
...
// Note that when this type is changed to float, then the reading and printing (scanf, printf) of values in
// evaluate_odometry might require updating
...
#endif  // KITTI_BENCHMARKER_MATRIX_HPP
