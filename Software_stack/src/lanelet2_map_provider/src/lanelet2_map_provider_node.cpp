...
RCLCPP_INFO(
  ...
  m_map_service =
    // this->create_service<aiim_autoware_msgs::srv::HADMapService>(
    this->create_service<aiim_autoware_msgs::srv::HADMapService>(
...
void Lanelet2MapProviderNode::handle_request(
  std::shared_ptr<aiim_autoware_msgs::srv::HADMapService_Request> request,
  std::shared_ptr<aiim_autoware_msgs::srv::HADMapService_Response> response)
{
  aiim_autoware_msgs::msg::HADMapBin msg;
  ...
  for (auto primitive : primitive_sequence) {
    if (primitive == aiim_autoware_msgs::srv::HADMapService_Request::DRIVEABLE_GEOMETRY) {
