...
#if defined(__WIN32)
#if defined(CONTROLLER_COMMON_BUILDING_DLL) ||                                 \
    defined(CONTROLLER_COMMON_EXPORTS)
#define CONTROLLER_COMMON_PUBLIC __declspec(dllexport)
#define CONTROLLER_COMMON_LOCAL
#else // defined(CONTROLLER_COMMON_BUILDING_DLL) ||
      // defined(CONTROLLER_COMMON_EXPORTS)
#define CONTROLLER_COMMON_PUBLIC __declspec(dllimport)
#define CONTROLLER_COMMON_LOCAL
#endif // defined(CONTROLLER_COMMON_BUILDING_DLL) ||
       // defined(CONTROLLER_COMMON_EXPORTS)
