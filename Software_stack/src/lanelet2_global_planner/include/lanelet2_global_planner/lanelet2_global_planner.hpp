...
using aiim_autoware_msgs::msg::TrajectoryPointAutoware;
...
public:
  ...
  bool8_t plan_route(
    TrajectoryPointAutoware & start, TrajectoryPointAutoware & end,
   ...
   */
  TrajectoryPointAutoware refine_pose_by_parking_spot(
    const lanelet::Id & parking_id,
    const TrajectoryPointAutoware & input_point) const;
