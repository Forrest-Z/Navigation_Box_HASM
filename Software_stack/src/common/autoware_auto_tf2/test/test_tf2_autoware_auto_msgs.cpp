...
/// \file
/// \brief This file includes common transform functionaly for autoware_auto_geometry_msgs
...
TEST(Tf2AutowareAuto, DoTransformClusters)
{
  ...
  aiim_autoware_msgs::msg::PointClusters p1;
  p1.points.resize(1);
  p1.points[0].x = 1;
  p1.points[0].y = 2;
  p1.points[0].z = 3;
  ...
  aiim_autoware_msgs::msg::PointClusters p_out;
  tf2::doTransform(p1, p_out, trans);
