...
def control_thread():
    ...
    joystick_sock = messaging.sub_sock(
        context,
    ...
    while True:
        ...
        # -1 to 1
        axis_3 = clip(-joystick.testJoystick.axes[3] * 1.05, -1., 1.)
        actuators.steer = axis_3
        actuators.steerAngle = axis_3 * 315.   # deg
        # -1 to 1
        axis_1 = clip(-joystick.testJoystick.axes[1] * 1.05, -1., 1.)
        ...
        if CS.steeringPressed or CS.gasPressed or CS.brakePressed:
            enabled = False
